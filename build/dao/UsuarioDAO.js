...
class UsuarioDAO {
    ...
    static iniciarSesion(parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            UsuarioEsquema_1.default.findOne({ correoUsuario: miCorreo })
                ...
                if (objeto) {
                    ...
                    if (claveCorrecta) {
                        ...
                        const miToken = jsonwebtoken_1.default.sign(datosVisibles, llavePrivada, {
                            expiresIn: 86400,
                        });
    ...
    static cantidadUsuariosEnPerfil(identificadorPerfil, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (mongoose_1.Types.ObjectId.isValid(identificadorPerfil)) {
                ...
                const cantidad = yield UsuarioEsquema_1.default.countDocuments({
                    codPerfil: llave,
                });
                ...
                UsuarioEsquema_1.default.findByIdAndUpdate({ _id: identificador }, { $set: jsonExterno }, (miError, objeto) => {
                    if (miError) {
                        ...
                        res
                            .status(400)
                            .json({
                            respuesta: "Error al actualizar el usuario, puede que el correo esté repetido",
                        });
                    }
                    else {
